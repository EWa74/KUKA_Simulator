...
>>>>>>> branch 'master' of https://github.com/EWa74/KUKA_Simulator.git
...
def create_PATHPTSObj
# remove the meshes, they have no users anymore.
        #for item in bpy.data.meshes:
        #    bpy.data.meshes.remove(item) 
        # Delete object on datablock        
        #for object_name in candidate_list:  
        #    bpy.data.objects[object_name].user_clear()   
        #    bpy.data.objects.remove(bpy.data.objects[object_name]) # Delete object on datablock     
        
                
        #for n in range(PATHPTSCountFile, PATHPTSCountFile+zuViel, 1):      
            # https://developer.blender.org/T28020
            
            #bpy.data.objects[PATHPTSObjList[n]].user_clear()
            #bpy.context.scene.objects.active = bpy.data.objects[PATHPTSObjList[n]]
            #bpy.ops.object.delete() # Delete object 
            #bpy.data.objects.remove(bpy.data.objects[PATHPTSObjList[n]]) # Delete object on datablock 
            
            #obj = bpy.data.objects[PATHPTSObjList[n]]
            #bpy.context.scene.objects.unlink(obj) 
            #bpy.data.objects[obj.name].user_clear() # If don't use this function, some object cannot delete and raise error. 
            #bpy.data.objects.remove(obj) 
            
            
            #bpy.data.objects[PATHPTSObjList[n]].user_clear()             # 20150327
            #bpy.data.objects[PATHPTSObjList[n]].select = True
            #bpy.ops.object.delete()
            #bpy.ops.object.select_all(action='DESELECT')
            #bpy.data.objects.remove(bpy.data.objects[PATHPTSObjList[n]]) # 20150327
